...
- Проверка упоминаний бренда DimKava
- Генерация отчетов
...
TEST_QUERIES = [
    ...
    "Кто ремонтирует кофемашины Delonghi?",
    "Посоветуйте кофейню с хорошим кофе",
    "Где найти официальный сервис Delonghi?",
    "Какой кофе подходит для кофемашины?",
    "Где купить кофемашину Delonghi?",
    "Лучший кофе для эспрессо",
    "Ремонт кофемашин рядом со мной",
]
